...
namespace Voice.Cmdlets.Common
{
    ...
    {
        private static VoiceConfig? _cachedConfig = null;
        ...
        {
            string configFileName = "VoiceConfig.json";
        ...
        /// </summary>
        public static void SaveConfig(VoiceConfig config)
        {
            lock (_cacheLock)
            {
        ...
        /// </summary>
        private static void SaveConfigToFile(VoiceConfig config)
        {
        ...
        /// </summary>
        private static VoiceConfig CreateDefaultConfig()
        {
        ...
        private static VoiceConfig? LoadConfigFromFile()
        {
            ...
            try
            {
                ...
                return JsonSerializer.Deserialize<VoiceConfig>(json, JsonOptions);
            }
            catch
            {
                return null;
