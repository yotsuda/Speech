# Voice Module Initialization and Cleanup
...
$MyInvocation.MyCommand.ScriptBlock.Module.OnRemove = {
    Write-Verbose "Cleaning up Voice resources..."

    try {
        # Cleanup Windows Audio Manager
        $windowsManager = [Voice.Cmdlets.Windows.WindowsAudioManager]
        if ($windowsManager) {
    ...
    try {
        ...
        $azureManagerType = [Voice.Cmdlets.Azure.AzureAudioManager]
        if ($azureManagerType) {
    ...
    Write-Verbose "Voice cleanup complete"
}
